            ...
            !(function () {
                ...
                $(".menu-button").on("click", function (e) {
                    ...
                    if (!($(e.target).parents().hasClass("menu-button") || $(e.target).hasClass("menu-button") || $(e.target).parents().hasClass("sidebar") || $(e.target).hasClass("sidebar"))) {
                        if ($(e.target).parents("a[data-toggle='collapse']").length > 0 || "collapse" == $(e.target).attr("data-toggle"))
                            return;
                        if ($("#app-container").hasClass("menu-sub-hidden") && 3 == v)
                            x(S() == W ? 2 : 0);
                        else
                            (($("#app-container").hasClass("menu-main-hidden") && $("#app-container").hasClass("menu-mobile")) || $("#app-container").hasClass("menu-hidden") || $("#app-container").hasClass("menu-mobile")) && x(0);
                    }
                });
                var W = "";
                function T(e) {
                    if (0 != $(".main-menu").length) {
                        var t = e ? e.replace("#", "") : "";
                        if (0 == $(".sub-menu ul[data-link='" + t + "']").length) {
                            if (($("#app-container").removeClass("sub-show-temporary"), 0 == $("#app-container").length))
                                return;
                            return (
                ...
                if (
                    ...
                    if (document.getElementById("polarChart")) {
                        ...
                        new Chart(Y, {
                            ...
                            data: {datasets: [{label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: [t, r, s], backgroundColor: [c, p, u], data: [80, 90, 50]}], labels: ["Cakes", "Desserts", "Cupcakes"]},
                        });
                    }
                    if (document.getElementById("polarChartNoShadow")) {
                        ...
                        new Chart(G, {
                            ...
                            data: {datasets: [{label: "Stock", borderWidth: 2, pointBackgroundColor: t, borderColor: [t, r, s], backgroundColor: [c, p, u], data: [80, 90, 70]}], labels: ["Cakes", "Desserts", "Cupcakes"]},
                        });
                    }
                    ...
                    if (document.getElementById("contributionChart1"))
                        new Chart(document.getElementById("contributionChart1").getContext("2d"), K);
                    if (document.getElementById("contributionChart2"))
                        new Chart(document.getElementById("contributionChart2").getContext("2d"), K);
                    if (document.getElementById("contributionChart3"))
                        new Chart(document.getElementById("contributionChart3").getContext("2d"), K);
                    var ee = {
                    ...
                    if (document.getElementById("ageChart")) {
                        ...
                        new Chart(ie, {
                            plugins: [ee],
                            type: "DoughnutWithShadow",
                            data: {labels: ["12-24", "24-30", "30-40", "40-50", "50-60"], datasets: [{label: "", borderColor: [t, r, s, l, d], backgroundColor: [c, p, u, h, m], borderWidth: 2, data: [15, 25, 20, 30, 14]}]},
                            draw: function () {},
                            options: {
                                plugins: {datalabels: {display: !1}},
                                responsive: !0,
                    ...
                    if (document.getElementById("workChart")) {
                        ...
                        new Chart(se, {
                            plugins: [ee],
                            type: "DoughnutWithShadow",
                            data: {labels: ["Employed for wages", "Self-employed", "Looking for work", "Retired"], datasets: [{label: "", borderColor: [t, r, s, l], backgroundColor: [c, p, u, h], borderWidth: 2, data: [15, 25, 20, 8]}]},
                            draw: function () {},
                            options: {
                                plugins: {datalabels: {display: !1}},
                                responsive: !0,
                    ...
                    if (document.getElementById("codingChart")) {
                        ...
                        new Chart(le, {
                            plugins: [ee],
                            type: "DoughnutWithShadow",
                            data: {labels: ["Python", "JavaScript", "PHP", "Java", "C#"], datasets: [{label: "", borderColor: [t, r, s, l, d], backgroundColor: [c, p, u, h, m], borderWidth: 2, data: [15, 25, 20, 8, 25]}]},
                            draw: function () {},
                            options: {
                                plugins: {datalabels: {display: !1}},
                                responsive: !0,
                ...
                if ($().DataTable) {
                    $(".data-table-standard").DataTable({
                        ...
                        language: {paginate: {previous: "<i class='simple-icon-arrow-left'></i>", next: "<i class='simple-icon-arrow-right'></i>"}, search: "_INPUT_", searchPlaceholder: "Search...", lengthMenu: "Items Per Page _MENU_"},
                    });
                    ...
                    e.preventDefault(),
                            ...
                            $.notify(
                                    {title: "Bootstrap Notify", message: "Here is a notification!", target: "_blank"},
                                    {
                                        ...
                                        icon_type: "class",
                                        template:
                                                '<div data-notify="container" class="col-11 col-sm-3 alert  alert-{0} " role="alert"><button type="button" aria-hidden="true" class="close" data-notify="dismiss">Ã—</button><span data-notify="icon"></span> <span data-notify="title">{1}</span> <span data-notify="message">{2}</span><div class="progress" data-notify="progressbar"><div class="progress-bar progress-bar-{0}" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;"></div></div><a href="{3}" target="{4}" data-notify="url"></a></div>',
                                    }
                            );
                }),
